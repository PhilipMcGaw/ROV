...
<html>
   ...
   <body onload="setTimeout('init(<?php echo "$mjpegmode, $video_fps, $divider" ?>);', 100);">
      ...
      <div class="container-fluid text-center liveimage">
         ...
         <div id="main-buttons">
            <input id="video_button" type="button" class="btn btn-primary" value ="Video" <?php getdisplayStyle('actions', $userLevel); ?>>
            <input id="image_button" type="button" class="btn btn-primary" value ="image"  <?php getdisplayStyle('actions', $userLevel); ?>>
            <input id="md_button" type="button" class="btn btn-primary" value ="md button"  <?php getdisplayStyle('settings', $userLevel); ?>>
            <input id="halt_button" type="button" class="btn btn-danger" value = "halto" " <?php getdisplayStyle('settings', $userLevel); ?>>
         </div>
      </div>
